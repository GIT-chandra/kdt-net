'''
This plots a model that produces 4096 points after creating KD-Tree as two separate models,
to visually check how much shape information is retained in both
'''
